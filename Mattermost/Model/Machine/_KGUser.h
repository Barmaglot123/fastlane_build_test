...
- (nullable NSString*)primitiveBackendStatus;
- (void)setPrimitiveBackendStatus:(nullable NSString*)value;
...
- (nullable NSNumber*)primitiveNicknameWidth;
- (void)setPrimitiveNicknameWidth:(nullable NSNumber*)value;
